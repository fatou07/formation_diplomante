...
@endif
          ...
          <tr>
              ...
              <td>
                 {{--  <form action="{{ route('specialites.destroy', $specialite->idspecialites)}}" method="post">
                  ...
                  <a href="{{ route('specialites.destroy', $specialite->idspecialites)}}" data-toggle="modal" onclick="deleteData({{$specialite->idspecialites}})" 
  ...
  <div>
    ...
    <div id="DeleteModal" class="modal fade text-danger" role="dialog">
        <form action="{{ route('specialites.destroy', $specialite->idspecialites)}}" id="deleteForm" method="post">
...
<script type="text/javascript">
  function deleteData(idspecialites)
  {
      var idspecialites = idspecialites;
      var url = '{{ route("specialites.destroy", ":idspecialites") }}';
      url = url.replace(':idspecialites', idspecialites);
