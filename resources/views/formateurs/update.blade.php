      ...
      <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="date" class="form-control" id="exampleInputlieu" aria-describedby="lieuHelp" placeholder="lieu de naissance">
          ...
          <div class="form-group">
            ...
            <input type="text" name="diplome" class="form-control" id="exampleInputdiplome" aria-describedby="diplomeHelp" placeholder="Enter nom diplome">
          ...
          <div class="form-group">
            ...
            <input type="text" name="Service" class="form-control" id="exampleInputService" aria-describedby="ServiceHelp" placeholder="Enter le nom du service">
        ...
        <div class="form-group">
          ...
          <input type="text" name="Specialite" class="form-control" id="exampleInputSpecialite" aria-describedby="SpecialiteHelp" placeholder="Enter le nom de Specialite">
